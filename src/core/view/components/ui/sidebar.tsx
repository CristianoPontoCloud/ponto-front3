...
import { SidebarSheet, SidebarSheetContent } from "./sheet-sidebar";
	...
	(
		...
		return (
			<div
				...
				style={{ display: hiddenSidebar ? "none" : "" }}
				data-state={state}
		...
		return (
			<ScrollArea>
				<main
					ref={ref}
					className={cn(
						"relative flex min-h-svh flex-1 flex-col bg-background h-[100vh]",
