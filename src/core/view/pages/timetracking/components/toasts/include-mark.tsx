...
interface TimetrackingIncludeMarkToastParams {
	hour: string;
	entryKey: EntryAndOutKey;
	name: string;
}

export function TimetrackingIncludeMarkToast({
	hour,
	entryKey,
	name,
}: TimetrackingIncludeMarkToastParams) {
	return (
		<>
			...
			<div>
				<p className="font-semibold">Marcação incluída!</p>
