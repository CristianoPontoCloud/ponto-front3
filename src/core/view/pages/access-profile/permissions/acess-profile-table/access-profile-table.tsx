...
import { useAccessProfileGrid } from "./use-access-profile-grid";

interface AccessProfileTableParams {
	height: number;
...
export function AccessProfileTable({
	...
	usersRolesQuery,
}: AccessProfileTableParams) {
	const divRef = useRef<HTMLDivElement | null>(null);
	const { columns, rows } = useAccessProfileGrid({
		divRef,
		rolesPermissionsQuery,
		usersRolesQuery,
	});
